/*По условие:
В първата колба никога не поставяй нищо, тъй като колкото и да наливаш в нея тя ще е винаги празна.
...
Колба:   Съдържание:
1       0
2       0 + 1                   съдържанието(0) на предходната колба събрано с номера й(1)
3       (0 + 1) + 2             съдържанието(0 + 1) на предходната колба събрано с номера й(2)
4       ((0 + 1) + 2) + 3       ....
...     ...
N       0 + 1 + ... + (N-1)
